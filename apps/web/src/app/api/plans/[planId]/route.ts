...
const updatePlanSchema = z.object({
  ...
  shippingType: z.enum(["INCLUDED", "FLAT_RATE", "CALCULATED", "FREE_OVER_AMOUNT"]).optional(),
    ...
    if (
      ...
      const newPrice = await createConnectedPrice(
        existingPlan.business.stripeAccountId,
        {
          ...
          trialPeriodDays: data.trialPeriodDays ?? existingPlan.trialPeriodDays ?? undefined,
          metadata: {
