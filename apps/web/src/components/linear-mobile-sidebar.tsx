...
export const LinearMobileSidebar = memo(function LinearMobileSidebar({ 
  ...
  return (
    <>
      {/* Mobile Header */}
      <header className="sticky top-0 z-50 bg-[#0e0f11] border-b border-white/[0.06] lg:hidden">
        <div className="flex items-center justify-between px-4 py-3">
          <button
            onClick={() => setIsOpen(true)}
            className="p-2 -ml-2 rounded-md hover:bg-white/[0.06] transition-colors"
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-white/90 text-sm truncate max-w-[150px]">
              {business.name}
            </span>
          </div>
      ...
      <div
        className={cn(
          "fixed inset-y-0 left-0 z-50 w-[280px] bg-[#0e0f11] border-r border-white/[0.06] transform transition-transform duration-300 ease-in-out lg:hidden",
      ...
      >
        <div className="h-full flex flex-col">
          ...
          {/* Bottom Section */}
          <div className="px-2 pb-4 border-t border-white/[0.06]">
            <div className="space-y-0.5 py-2">
              ...
              <a
                ...
                className="flex items-center gap-2.5 px-3 py-2.5 rounded-md text-[13px] font-medium text-white/60 hover:text-white/90 hover:bg-white/[0.04] transition-colors"
              >
              ...
              <button
                ...
                className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-md text-[13px] font-medium text-white/60 hover:text-white/90 hover:bg-white/[0.04] transition-colors"
              >
            ...
            <div className="pt-2 border-t border-white/[0.06]">
              <div className="flex items-center gap-2.5 p-2.5 rounded-md bg-white/[0.04]">
                {business.logoUrl ? (
                  <img
                    src={business.logoUrl}
                    alt={business.name}
            ...
            {otherBusinesses.length > 0 && (
              <div className="pt-2">
                <p className="px-3 py-1 text-[11px] text-white/40 uppercase tracking-wide">Switch</p>
