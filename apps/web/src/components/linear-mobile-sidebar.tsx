        ...
        <div className="h-full flex flex-col">
          ...
          <div className="px-2 pb-4 border-t border-neutral-400">
            ...
            {otherBusinesses.length > 0 && (
              <div className="pt-2">
                <p className="px-3 py-1 text-[11px] text-neutral-800 uppercase">Switch</p>
                {otherBusinesses.map((b) => (
                  ...
                  >
                    {b.logoUrl ? (
                      ...
                      <div className="h-7 w-7 rounded bg-neutral-400 flex items-center justify-center">
                        <span className="text-neutral-900 font-semibold text-[10px]">
                          {b.name.charAt(0).toUpperCase()}
                        </span>
                      </div>
                    )}
                    <span className="text-[13px] text-neutral-900 truncate">{b.name}</span>
                  </Link>
                ))}
              </div>
            )}
