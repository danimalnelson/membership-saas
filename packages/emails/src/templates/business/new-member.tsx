 ...
 * Sent to business owner when a new member signs up
 */

export interface NewMemberEmailProps {
  businessName: string;
  memberName: string;
  memberEmail: string;
  planName: string;
...
export function NewMemberEmail(props: NewMemberEmailProps): string {
  const { businessName, memberName, memberEmail, planName, amount, currency, dashboardUrl } = props;
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); padding: 30px; text-align: center; border-radius: 8px 8px 0 0;">
    <h1 style="color: white; margin: 0;">New Member!</h1>
  </div>
  
  <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 8px 8px;">
    <p style="font-size: 16px; margin-bottom: 20px;">Great news for ${businessName}!</p>
    
    <p style="font-size: 16px; margin-bottom: 20px;">A new member has just signed up for your wine club.</p>
...
export const newMemberEmail = NewMemberEmail;
